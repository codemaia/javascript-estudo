...
*/
                                                //como queremos as duas ultimas letras, podemos omitir o segundo parametro 
const dessert = `${dogNames[0].slice(3, 5)}${dogNames[1].slice(2)}${dogNames[3].slice(2, 4).replace('n', 'd')}`
